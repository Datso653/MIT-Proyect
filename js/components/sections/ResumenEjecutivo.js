        ...
        <div style={{
          ...
          <div style={{
            ...
            <p style={{
              ...
              Modelo predictivo basado en antigüedad, equipo y expectativas.
            </p>
          </div>
          ...
          <div style={{
            ...
            border: `1px solid ${COLORS.border}`,
            borderRadius: '8px',
            borderLeft: `4px solid ${COLORS.accentDark}`
          }}>
            <div style={{
              fontSize: '13px',
              fontWeight: '600',
            ...
            <p style={{
              ...
              Análisis de factores externos y su impacto en ventas.
            </p>
          </div>
        </div>
